            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  {/* <p className="about-para">I am a skilled frontend developer with over 3yrs of experience in the industry.My passion lies in creating
                    responsive, user friendly web applications through frontend development. I take pride in staying
                  ...
                  <a target="_blank" href="https://github.com/Dimple-Ramya" className="git-link">Browse My Work <ArrowRightCircle size={25} /></a>
                </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
